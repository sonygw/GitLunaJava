...
public class jfCommandesExist extends JFrame {
	...
	public jfCommandesExist() {
		...
		button_retour.setRolloverIcon(new ImageIcon(jfCommandesExist.class.getResource("/Images/gestion/Home-48-actif.png")));
		...
		label.setIcon(new ImageIcon(jfCommandesExist.class.getResource("/Images/gestion/commande/Shopping-Bag-64-actif.png")));
		label.setFont(new Font("Dialog", Font.BOLD, 20));
		label.setBounds(10, 12, 203, 67);
		panel.add(label);
		
		JButton button_apercu = new JButton("Aper\u00E7u");
		button_apercu.setRolloverIcon(new ImageIcon(jfCommandesExist.class.getResource("/Images/gestion/Preview-48-actif.png")));
		...
		button_impr.setRolloverIcon(new ImageIcon(jfCommandesExist.class.getResource("/Images/gestion/Printer-48-actif.png")));
		...
		button_exporter.setRolloverIcon(new ImageIcon(jfCommandesExist.class.getResource("/Images/gestion/Data-Export-48-actif.png")));
		button_exporter.setIcon(new ImageIcon(jfCommandesExist.class.getResource("/Images/gestion/Data-Export-48.png")));
		...
		btnSupprimer.setRolloverIcon(new ImageIcon(jfCommandesExist.class.getResource("/Images/gestion/Garbage-Open-48-actif.png")));
		...
		DefaultTableModel tblModel = new DefaultTableModel(tableData,
				new String[] {
						"id", "Ref", "Prix", "idC", "Client" , "Date", "Reglement"
					}) {
			@Override
		...
		btnSupprimer.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				//artComDao.DeleteArticleFromCommande(obj)
				
				if (commandeDao.DeleteCommande(Integer.parseInt(tblModel.getValueAt(table.getSelectedColumn(), 0).toString())))
