...
public class jpClientsRecherche extends JPanel {
	...
	public jpClientsRecherche(jfClients jfc) {
		...
		panel_2.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0), 2), "Recherche client",
		...
		groupLayout.setVerticalGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
				.addGroup(groupLayout.createSequentialGroup().addContainerGap()
						...
						.addComponent(panel, GroupLayout.PREFERRED_SIZE, 238, GroupLayout.PREFERRED_SIZE).addGap(18)
		...
		btnClients.setRolloverIcon(
				new ImageIcon(jpClientsRecherche.class.getResource("/Images/gestion/client/User-Find-64.png")));
		...
		gl_panel_1.setHorizontalGroup(gl_panel_1.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(gl_panel_1.createSequentialGroup().addContainerGap()
						.addComponent(btnNewButton, GroupLayout.DEFAULT_SIZE, 138, Short.MAX_VALUE).addContainerGap())
				.addGroup(gl_panel_1.createSequentialGroup().addContainerGap()
						.addComponent(btnExport, GroupLayout.DEFAULT_SIZE, 138, Short.MAX_VALUE).addContainerGap())
				.addGroup(gl_panel_1.createSequentialGroup().addContainerGap()
		...
		gl_panel_1.setVerticalGroup(gl_panel_1.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel_1.createSequentialGroup().addContainerGap().addComponent(btnClients)
						.addPreferredGap(ComponentPlacement.RELATED).addComponent(btnNewButton).addGap(196)
						...
						.addPreferredGap(ComponentPlacement.RELATED).addComponent(btnExport).addGap(33)
						.addComponent(btnNewButton_1).addContainerGap(81, Short.MAX_VALUE)));
