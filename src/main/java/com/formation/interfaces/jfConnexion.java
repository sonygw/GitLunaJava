...
public class jfConnexion extends JFrame {
	...
	public jfConnexion() {
		...
		lblSarlLunaBienvenue
				.setIcon(new ImageIcon(jfConnexion.class.getResource("/Images/connection/Shopping-Cart-05-48.png")));
		...
		btnAnnuler
				.setRolloverIcon(new ImageIcon(jfConnexion.class.getResource("/Images/connection/Stop-48-actif.png")));
