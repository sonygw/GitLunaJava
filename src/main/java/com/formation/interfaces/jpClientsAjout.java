...
import com.formation.utilitaires.Regex;
...
public class jpClientsAjout extends JPanel {
	...
	public jpClientsAjout(jfClients jfc) {
		...
		panel.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0)), "Clients", TitledBorder.LEADING,
		...
		gl_panel.setHorizontalGroup(gl_panel.createParallelGroup(Alignment.LEADING).addGroup(gl_panel
				...
				.addComponent(textField_code, GroupLayout.PREFERRED_SIZE, 116, GroupLayout.PREFERRED_SIZE).addGap(18)
				...
				.addGap(18).addComponent(chckbxCarteDeFidlit).addContainerGap(10, Short.MAX_VALUE)));
		gl_panel.setVerticalGroup(gl_panel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel.createParallelGroup(Alignment.BASELINE)
						.addComponent(textField_code, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE)
						.addComponent(label_6))
				.addGroup(gl_panel.createParallelGroup(Alignment.BASELINE).addComponent(label_7)
						.addComponent(chckbxCarteDeFidlit).addComponent(formattedTextField_date,
		...
		panel_2.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0)), "Etat civil", TitledBorder.LEADING,
				TitledBorder.TOP, null, new Color(0, 0, 0)));

		JPanel panel_3 = new JPanel();
		panel_3.setBackground(new Color(173, 216, 230));
		panel_3.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0), 1, true), "Coordonn\u00E9es",
		...
		groupLayout.setHorizontalGroup(groupLayout.createParallelGroup(Alignment.TRAILING).addGroup(groupLayout
				...
				.addGroup(groupLayout.createParallelGroup(Alignment.LEADING, false)
						.addComponent(panel_4, 0, 0, Short.MAX_VALUE).addComponent(panel_3, 0, 0, Short.MAX_VALUE)
		...
		groupLayout.setVerticalGroup(groupLayout.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(groupLayout.createSequentialGroup().addContainerGap()
						.addComponent(panel, GroupLayout.PREFERRED_SIZE, 49, GroupLayout.PREFERRED_SIZE).addGap(18)
						.addComponent(panel_2, GroupLayout.PREFERRED_SIZE, 141, GroupLayout.PREFERRED_SIZE).addGap(18)
						.addComponent(panel_3, GroupLayout.PREFERRED_SIZE, 95, GroupLayout.PREFERRED_SIZE).addGap(18)
				...
				.setHorizontalGroup(gl_panel_3.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel_3.createSequentialGroup().addContainerGap()
								.addGroup(gl_panel_3.createParallelGroup(Alignment.LEADING)
										.addComponent(lblTlphone, GroupLayout.PREFERRED_SIZE, 57,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(lblEmail))
								.addPreferredGap(ComponentPlacement.UNRELATED)
								.addGroup(gl_panel_3.createParallelGroup(Alignment.TRAILING)
										.addComponent(textField_telephone, GroupLayout.DEFAULT_SIZE, 510,
												Short.MAX_VALUE)
		...
		gl_panel_3.setVerticalGroup(gl_panel_3.createParallelGroup(Alignment.LEADING).addGroup(gl_panel_3
				...
				.addGroup(gl_panel_3.createParallelGroup(Alignment.BASELINE)
						.addComponent(textField_telephone, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE)
						.addComponent(lblTlphone))
				.addPreferredGap(ComponentPlacement.RELATED, 12, Short.MAX_VALUE)
				.addGroup(gl_panel_3
						.createParallelGroup(Alignment.BASELINE).addComponent(textField_email,
								GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
						.addComponent(lblEmail))
				.addContainerGap()));
		...
		gl_panel_2.setHorizontalGroup(gl_panel_2.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_panel_2.createSequentialGroup().addContainerGap()
						.addGroup(gl_panel_2.createParallelGroup(Alignment.LEADING).addComponent(lblCodePostal)
								.addComponent(label)
						...
						.addGroup(gl_panel_2.createParallelGroup(Alignment.LEADING, false)
								...
								.addGroup(gl_panel_2.createSequentialGroup()
										.addComponent(textField_CodePostal, GroupLayout.PREFERRED_SIZE, 111,
												GroupLayout.PREFERRED_SIZE)
										.addGap(190).addComponent(lblVille)
										.addPreferredGap(ComponentPlacement.UNRELATED).addComponent(textField_Ville))
								.addGroup(gl_panel_2.createSequentialGroup()
										.addComponent(textField_Prenom, GroupLayout.PREFERRED_SIZE, 283,
												GroupLayout.PREFERRED_SIZE)
										.addGap(18).addComponent(label_1).addPreferredGap(ComponentPlacement.RELATED)
										.addComponent(textField_Nom, GroupLayout.PREFERRED_SIZE, 176,
												GroupLayout.PREFERRED_SIZE)))
						.addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
		gl_panel_2.setVerticalGroup(gl_panel_2.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel_2.createSequentialGroup().addContainerGap()
						.addGroup(gl_panel_2.createParallelGroup(Alignment.BASELINE)
								.addComponent(textField_Prenom, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
								.addComponent(textField_Nom, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
								.addComponent(label_1).addComponent(label))
						.addGap(18)
						.addGroup(gl_panel_2.createParallelGroup(Alignment.BASELINE).addComponent(label_8).addComponent(
								textField_Adresse, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE))
						.addGap(18)
						.addGroup(
								gl_panel_2.createParallelGroup(Alignment.BASELINE)
										.addComponent(textField_CodePostal, GroupLayout.PREFERRED_SIZE,
												GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
										.addComponent(lblVille)
										.addComponent(textField_Ville, GroupLayout.PREFERRED_SIZE,
												GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
		...
		btnNewButton_1.setRolloverIcon(
				new ImageIcon(jpClientsAjout.class.getResource("/Images/gestion/Cancel-48-actif.png")));
		...
		btnClients.setRolloverIcon(
				new ImageIcon(jpClientsAjout.class.getResource("/Images/gestion/client/User-Add-64.png")));
		...
		btnSauvegarder
				.setRolloverIcon(new ImageIcon(jpClientsAjout.class.getResource("/Images/gestion/Save-48-actif.png")));
		...
		gl_panel_1.setHorizontalGroup(gl_panel_1.createParallelGroup(Alignment.TRAILING).addGroup(gl_panel_1
				...
				.addGroup(gl_panel_1.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel_1.createSequentialGroup().addComponent(btnSauvegarder).addContainerGap(33,
								Short.MAX_VALUE))
		...
		gl_panel_1.setVerticalGroup(gl_panel_1.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel_1.createSequentialGroup().addGap(7).addComponent(btnClients)
						.addPreferredGap(ComponentPlacement.UNRELATED).addComponent(btnSauvegarder).addGap(114)
						...
						.addPreferredGap(ComponentPlacement.RELATED).addComponent(btnExport).addGap(70)
						.addComponent(btnNewButton_1).addContainerGap(261, Short.MAX_VALUE)));
		...
		textField_code.setText(codecli);
		...
		btnSauvegarder.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (textField_email.getText().isEmpty() || textField_telephone.getText().isEmpty()
						|| textField_remarques.getText().isEmpty() || textField_CodePostal.getText().isEmpty()
						|| textField_Adresse.getText().isEmpty() || textField_code.getText().isEmpty()
						|| textField_Nom.getText().isEmpty() || textField_Prenom.getText().isEmpty()
						|| textField_Ville.getText().isEmpty() || formattedTextField_date.getText().isEmpty()) {
					JOptionPane.showMessageDialog(null,
							"Un des champs est vide. \nMerci de remplir le formulaire convenablement");

				} else {
					if (!Regex.testCP(textField_CodePostal.getText())
							&& !Regex.testNum(textField_telephone.getText())) {

						cli = new Client(-1, textField_Nom.getText(), textField_Prenom.getText(),
								textField_email.getText(),
								textField_Adresse.getText() + " " + textField_CodePostal.getText() + " "
										+ textField_Ville.getText(),
								chckbxCarteDeFidlit.isSelected(), textField_telephone.getText(),
								textField_remarques.getText(), formattedTextField_date.getText(),
						...
						JOptionPane.showMessageDialog(null,
								"Merci de vérifier le code postal et/ou le numéro de téléphone.");
